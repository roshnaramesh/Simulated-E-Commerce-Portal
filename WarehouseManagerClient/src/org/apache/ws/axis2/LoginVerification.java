...
/**
 * Servlet implementation class LoginVerification - To check credentials of Warehouse Manaer
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// TODO Auto-generated method stub
				...
				try {
					...
					sess.setAttribute("warehouseID",warehouseID);
					rs = stmt.executeQuery("SELECT PASSWORD FROM WAREHOUSE_ADMIN WHERE USERNAME='"+usn+"' AND PASSWORD='"+pwd+"'");
